...
urlpatterns = [
    ...
    path('estadisticas/', views.estadisticas_base, name='estadisticas_base'),
    path('estadisticas/coches', views.estadisticas_coches, name='estadisticas_coches'),
    path('estadisticas/accesorios', views.estadisticas_accesorios, name='estadisticas_accesorios'),
